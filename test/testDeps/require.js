...
(function(ca) {
    ...
    function ha(b) {
        ...
        function d(a) {
            z && v(document.getElementsByTagName(`script`), (e) => {
        ...
        function u(a) {
            let e, b = a ? a.indexOf(`!`) : -1; - 1 < b && (e = a.substring(0,
        ...
        function m(a, e, b, f) {
            ...
            a = a[1];
            g && (g = c(g, h, f), d = j(p, g));
            a && (g ? k = d && d.normalize ? d.normalize(a, (a) => c(a, h, f)) : c(a, h, f) : (k = c(a, h, f), a = u(k), g = a[0], k = a[1], b = !0, n = i.nameToUrl(k)));
        ...
        function F(a, e, b) {
            const f = a.map.id;
            a.error ? a.emit(`error`, a.error) : (e[f] = !0, v(a.depMaps, (f, c) => {
                let d = f.id,
                    g = j(k, d);
        ...
        function D() {
            let a, e, b = (a = 1E3 * l.waitSeconds) && i.startTime + a < (new Date).getTime(),
                f = [],
                c = [],
                h = !1,
                k = !0;
            ...
            callPlugin() {
                ...
                r(d, `defined`, t(this, function(f) {
                    ...
                    if (this.map.unnormalized) {
                        if (f.normalize && (J = f.normalize(J, (a) => {
                                return c(a, u, !0)
    ...
    if (`undefined` === typeof define) {
        ...
        h({});
        v([`toUrl`, `undef`, `defined`, `specified`], (b) => {
            h[b] = function() {
                let c = F._;
        ...
        z && !r.skipDataMain && U(document.getElementsByTagName(`script`), (b) => {
            y || (y = b.parentNode);
        ...
        define = function(b, c, d) {
            ...
            H(c) || (d = c, c = null);
            !c && G(d) && (c = [], d.length && (d.toString().replace(la, ``).replace(ma, (b, d) => {
                c.push(d)
            }), c = (1 === d.length ? [`require`] : [`require`, `exports`, `module`]).concat(c)));
            if (O) {
                if (!(g = L)) {
                    P && `interactive` === P.readyState || U(document.getElementsByTagName(`script`), (b) => {
